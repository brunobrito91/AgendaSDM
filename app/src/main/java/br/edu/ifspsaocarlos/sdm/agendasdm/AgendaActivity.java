...
public class AgendaActivity extends ListActivity {
    ...
    // Lista de contatos estática para testes
    ...
    public void onCreate(Bundle savedInstance) {
        ...
        } else {    /* Preenchendo lista de contatos */
    ...
    public boolean onContextItemSelected(MenuItem item) {
        AdapterView.AdapterContextMenuInfo informacoes = (AdapterView.AdapterContextMenuInfo) item.getMenuInfo();
        ContatoArrayAdapter adaptador = (ContatoArrayAdapter) getListAdapter();
        ...
        switch (item.getItemId()) {
            ...
            case R.id.chamar_contato:
                ...
                try {
                    ...
                    Toast.makeText(this, getString(R.string.mensagem_erro_chamada), Toast.LENGTH_SHORT).show();
                }
                break;
        }
